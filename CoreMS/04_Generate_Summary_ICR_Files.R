...
# User Input
Sample_Name = "ECA_VGC" # Sample name for output; user will need to change to "YDE21_7T_OG" if using 7T data
...
############### Summary generation ############### 
  ...
  write.csv(characteristics, paste(Sample_Name, "_MolInfo_Summary_Unique_Peaks.csv", sep = ""), quote = F)
