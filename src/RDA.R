...
# ====== Read in data ======
data = read.csv('Medians_of_Weighted_averages_for_molecular_properties_per_site_and_treatment.csv')
...
vif_values <- vif(lm(Median_SpC_microsiemens_per_cm ~ Median_pH + Median_Temperature_degC + 
                       ...
                       Median_01397_N_percent_per_mg + Percent_Fine_Sand, data = explanatory_data1))
print(vif_values)
